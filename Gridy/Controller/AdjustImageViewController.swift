...
class AdjustImageViewController: UIViewController, UIGestureRecognizerDelegate {
        ...
        func drawing() {
            ...
            let image = renderer.image { (ctx) in
                if view.frame.width < view.frame.height {
                    ...
                    cropImageBoxView.frame = CGRect(x: 0.0, y: 0.0, width: squareDimension, height: squareDimension)
        ...
        func drawGrid(context: UIGraphicsImageRendererContext, squareDimension: CGFloat) {
            ...
            func cropImage() -> UIImage {
                ...
                view.drawHierarchy(in: userChosenImage.bounds, afterScreenUpdates: true)
